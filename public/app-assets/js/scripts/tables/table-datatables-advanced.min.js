...
rangePickr.length && rangePickr.flatpickr({
    mode: "range", dateFormat: "m/d/Y", onClose: function (t, a, e) {
        var l = "", n = new Date;
...
var filterByDate = function (t, a, e) {
    $.fn.dataTableExt.afnFiltering.push((function (l, n, o) {
        var r = normalizeDate(n[t]), d = normalizeDate(a), s = normalizeDate(e);
...
$((function () {
    ...
    var t = $(".datatables-ajax"), a = $(".dt-column-search"), e = $(".dt-advanced-search"), l = $(".dt-responsive"),
        n = "../../../app-assets/";
    ...
    if (e.length) e.DataTable({
        ajax: n + "data/table-datatable.json",
        columns: [{data: "responsive_id"}, {data: "full_name"}, {data: "email"}, {data: "post"}, {data: "city"}, {data: "start_date"}, {data: "salary"}],
    ...
    if ($("input.dt-input").on("keyup", (function () {
        ...
        ajax: n + "data/table-datatable.json",
        columns: [{data: "responsive_id"}, {data: "full_name"}, {data: "email"}, {data: "post"}, {data: "city"}, {data: "start_date"}, {data: "salary"}, {data: "age"}, {data: "experience"}, {data: "status"}],
        columnDefs: [{className: "control", orderable: !1, targets: 0}, {
