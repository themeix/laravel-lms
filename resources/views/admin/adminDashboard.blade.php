                        ...
                        <div class="card card-app-design">
                            <div class="card-body">
                                ...
                                <div class="design-group pt-25">
                                    ...
                                    <div class="avatar">
                                        <img
                                            src="{{asset('app-assets/images/portrait/small/avatar-s-9.jpg" width="34" height="34" alt="Avatar')}}"/>
                                    </div>
                                    ...
                                    <div class="avatar">
                                        <img
                                            src="{{asset('app-assets/images/portrait/small/avatar-s-7.jpg" width="34" height="34" alt="Avatar')}}"/>
                                    </div>
