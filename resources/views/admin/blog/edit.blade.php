        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Blog Post</h2>
            ...
            <section class="bs-validation">
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" action="{{route('blog.update', [$blog->uuid])}}" method="post"
                                ...
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input
                                                type="text"
                                                name="slug" id="slug" value="{{$blog->slug}}"
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
                                            <label class="form-label" for="basic-addon-name"> Details <span
                                                    class="text-danger">*</span></label>
                                            <textarea class="form-control" id="body"  placeholder="Enter the Details" name="details">{{$blog->details}}</textarea>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-12 mb-2">
                                        <div class="border rounded p-2">
                                            ...
                                            <div class="d-flex flex-column flex-md-row">
                                                @if($blog->image)
                                                    <img src="{{asset($blog->image_path)}}" id="blog-feature-image" class="rounded me-2 mb-1 mb-md-0" width="170" height="110" alt="Blog Featured Image" />
                                                @else
                                                ...
                                                <div class="featured-info">
                                                    ...
                                                    @endif
                                                    <p>Accepted Size: 870 x 500 (1MB)</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
