                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                ...
                                                <form action="{{route('city.delete', [$city->uuid])}}" class="mb-0" method="post" class="d-inline">
                                                    @csrf

                                                    <a href="{{route('city.delete', [$city->uuid])}}"  class="btn-action confirm-delete"  title="Delete">
