                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="{{route('country.index')}}">Tag List</a>
                                </li>
            ...
            <section class="bs-validation">
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" action="{{route('country.store')}}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
