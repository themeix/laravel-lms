                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Instructor List
                                </li>
                            </ol>
                        </div>
                    </div>
                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons text-center" style="width: 80px">
                                                ...
                                                <form action="{{route('instructor.delete', [$instructor->uuid])}}" class="mb-0" method="post" class="d-inline">
                                                    @csrf

                                                    <a href="{{route('instructor.delete', [$instructor->uuid])}}"  class="btn-action confirm-delete"  title="Delete">
