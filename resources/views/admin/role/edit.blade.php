            ...
            <section class="bs-validation">
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation" action="{{route('role.update', [$role->id])}}" method="post"
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-check mb-2 d-flex align-items-center">
                                                            <input class="form-check-input p-1" type="checkbox"
                                                                   ...
                                                                   value="{{$permission->id}}" @if(in_array($permission->id, $selected_permissions)) checked @endif >
                                                            <label class="form-check-label  ps-1 color-heading"
