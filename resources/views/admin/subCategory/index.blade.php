                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                ...
                                                <form action="{{route('subCategory.delete', [$subcategory->uuid])}}" class="mb-0" method="post" class="d-inline">
                                                    @csrf

                                                    <a href="{{route('subCategory.delete', [$subcategory->uuid])}}"  class="btn-action confirm-delete"  title="Delete">
