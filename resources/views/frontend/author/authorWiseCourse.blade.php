        ...
        <div class="container">
            <div class="breadcrumb-titel md:w-7/12 m-auto text-center z-10 relative">
                <h2 class="xl:text-6xl lg:text-5xl md:text-4xl text-3xl text-black-200  font-medium" data-aos="fade-up"
                    data-aos-delay="100">Instructor</h2>
            </div>
    ...
    <div class="hero-author text-center relative md:-mt-20 -mt-16" data-aos="fade-up" data-aos-delay="300">
        <div class="container">
            <img class="w-32 h-32 rounded-full object-cover mx-auto mb-4"
                 src="{{getImageFile($instructor->user ? @$instructor->user->image : '')}}" alt="image">
            <h5 class="font-serif md:text-3xl text-2xl text-black-200 font-medium ">{{$instructor->name}}</h5>
            <p class="text-base leading-relaxed font-normal">{{$instructor->publishedCourses->count()}} Courses
                published</p>
        </div>
    </div>
        ...
        <div class="container mx-auto">
            <div class="tab-slider--nav border-b  mb-8 lg:mb-14">
                <ul class="tab-slider--tabs">
                    <li class="tab-slider--trigger text-xl  font-medium active" rel="tab1">All Courses
