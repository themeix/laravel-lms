                                            ...
                                            <div class="col-span-4">
                                                <div class="blog-slider-images">
                                                    <a href="blog.html"><img
                                                            ...
                                                            src="{{asset('frontend/assets/images/blog-post-1.jpg')}}"
                                                            alt="images"></a>
                                                </div>
                                            </div>
                    ...
                    <div class="site-menu shadow-5xl bg-white p-10">
                                ...
                                <div class="col-span-4">
                                    <div class="blog-post-item-images h-full">
                                        <img class="rounded h-full object-cover"
                                             src="{{asset('frontend/assets/images/blog/blog-site-item-1.png')}}"
                                             alt="images">
                                    </div>
                                </div>
                                <div class="col-span-8">
                        ...
                        <div class="blog-post-item mt-10 border-b pb-10">
                            <div class="grid grid-cols-12 gap-4 items-center">
                                <div class="col-span-4">
                                    <div class="blog-post-item-images h-full">
                                        <img class="rounded h-full object-cover"
                                             src="{{asset('frontend/assets/images/blog/blog-site-item-2.png')}}"
                                             alt="images">
                                    </div>
                                </div>
                                <div class="col-span-8">
                        ...
                        <div class="blog-post-item mt-10">
                            <div class="grid grid-cols-12 gap-4 items-center">
                                <div class="col-span-4">
                                    <div class="blog-post-item-images h-full">
                                        <img class="rounded h-full object-cover"
                                             src="{{asset('frontend/assets/images/blog/blog-site-item-3.png')}}"
                                             alt="images">
                                    </div>
                                </div>
                                <div class="col-span-8">
                        ...
                        <div class="categories-box md:pt-16 pt-10">
                            ...
                            <ul class="mt-10 gap-3 flex flex-wrap">
                                <li>
                                    <a class="bg-blue-100 block hover:bg-blue-600 font-medium transition duration-500 px-5 py-3 hover:text-white rounded"
