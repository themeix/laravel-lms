                        ...
                        <div class="countery-box border-blue-5  rounded ">
                            <div class="grid md:grid-cols-2 gap-4">
                                ...
                                <div class="flex-col select-box" >
                                    <p class="text-black-200 mb-4 text-lg"> Country<span class="text-blue-800">*</span>
                                    </p>
                                    <select class="w-full arifSelect bg-white text-gray-500"  name="country_id" id="country_id">
                                        <option value="">--- Select Country ---</option>

                                        @foreach ($countries as $country)
                                            <option value="{{ $country->id }}"
                                            @if (old('country_id')) {{ old('country_id') == $country->id ? 'selected' : '' }} @else  {{ $user->country_id == $country->id ? 'selected' : '' }} @endif>
                                ...
                                <div class="flex-col">
                                    <p class="text-black-200 mb-4 text-lg"> State <span class="text-blue-800">*</span>
                                    </p>
                                    <select class="w-full arifSelect bg-white text-gray-500"  name="state_id" id="state_id">
                            ...
                            <div class="grid  gap-4 pt-4">
                                <div class="flex-col">
                                    ...
                                    <textarea rows="2"
                                        class=" appearance-none border rounded w-full py-2.5 px-3 bg-white  placeholder-gray-500 leading-tight focus:outline-none focus:shadow-outline" name="address"
