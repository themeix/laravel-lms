        ...
        <div class="container">
            <div class="breadcrumb-titel md:w-7/12 m-auto text-center z-10 relative">
                <h2 class="xl:text-6xl lg:text-5xl md:text-4xl text-3xl text-black-200  font-medium"
                    data-aos="fade-up" data-aos-delay="100">Web Design</h2>
            </div>
            ...
            <ul class="flex gap-2 justify-center mt-6 relative z-10"  data-aos="fade-up" data-aos-delay="200">
                ...
                <li>/</li>
                <li> <a class="hover:text-blue-600 transition duration-500" href="#">Categories </a></li>
                <li>/</li>
                <li> <a class="hover:text-blue-600 transition duration-500" href="#">Courses</a></li>
            </ul>
        ...
        <div class="container">
            <div class="menu-bar mb-12 flex justify-between flex-wrap gap-12">
                <ul class="flex gap-4 flex-wrap">
                    <li><a class="bg-blue-5 inline-block hover:text-white py-2 px-5 rounded hover:bg-blue-600 transition duration-500"
                           href="course-catagory.html">Show All</a></li>
                    <li><a class="bg-blue-5 inline-block hover:text-white py-2 px-5 rounded hover:bg-blue-600 transition duration-500"
                           href="course-catagory.html">Web design</a></li>
                    <li><a class="bg-blue-5 inline-block hover:text-white py-2 px-5 rounded hover:bg-blue-600 transition duration-500"
                           href="course-catagory.html">Graphics Design</a></li>
                    <li><a class="bg-blue-5 inline-block hover:text-white py-2 px-5 rounded hover:bg-blue-600 transition duration-500"
                           href="course-catagory.html">IT & Technology</a></li>
                    <li><a class="bg-blue-5 inline-block hover:text-white py-2 px-5 rounded hover:bg-blue-600 transition duration-500"
                           href="course-catagory.html">Development</a></li>
                    <li><a class="bg-blue-5 inline-block hover:text-white py-2 px-5 rounded hover:bg-blue-600 transition duration-500"
                           href="course-catagory.html">Photography</a></li>
                </ul>
                <select class="">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-6">
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="300">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-1.webp')}}" alt="images"></a>
                    ...
                    <div class="lessons-bottom-box p-6 border border-blue-20 border-t-0 rounded-bl-md rounded-br-md">
                        ...
                        <h3 class="md:text-2xl text-xl font-semibold mt-5 text-black-200 mb-2 hover:text-blue-600"><a
                                href="course.html">3 Quick Tricks to Boost Customer Retention</a></h3>
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="600">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-2.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                    ...
                    <div class="lessons-bottom-box p-6 border border-blue-20 border-t-0 rounded-bl-md rounded-br-md">
                        ...
                        <h3 class="md:text-2xl text-xl font-semibold mt-5 text-black-200 mb-2 hover:text-blue-600"><a
                                href="course.html">Psychology in Web Design: How to Use it Right</a></h3>
                        <div class="reviews-box flex justify-between pt-5">
                            <div class="flex items-center">
                              <span class="mr-2"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                      xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="900">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-3.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                    ...
                    <div class="lessons-bottom-box p-6 border border-blue-20 border-t-0 rounded-bl-md rounded-br-md">
                        ...
                        <h3 class="md:text-2xl text-xl font-semibold mt-5 text-black-200 mb-2 hover:text-blue-600"><a
                                href="course.html">How to Get Started With UX Research</a></h3>
                        <div class="reviews-box flex justify-between pt-5">
                            <div class="flex items-center">
                              <span class="mr-2"><svg width="20" height="20" viewBox="0 0 20 20" fill="none"
                                                      xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="1200">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-4.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="1500">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-5.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                    ...
                    <div class="lessons-bottom-box p-6 border border-blue-20 border-t-0 rounded-bl-md rounded-br-md">
                        <div class="name-box flex justify-between">
                            <a class="hover:text-blue-600" href="author.html">Kristin Watson</a>
                            <span class="text-blue-50">12 July, 2022</span>
                        </div>
                        <h3 class="md:text-2xl text-xl font-semibold mt-5 text-black-200 mb-2 hover:text-blue-600"><a
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="1800">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-6.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                    ...
                    <div class="lessons-bottom-box p-6 border border-blue-20 border-t-0 rounded-bl-md rounded-br-md">
                        <div class="name-box flex justify-between">
                            <a class="hover:text-blue-600" href="author.html">Esther Howard</a>
                            <span class="text-blue-50">12 July, 2022</span>
                        </div>
                        <h3 class="md:text-2xl text-xl font-semibold mt-5 text-black-200 mb-2 hover:text-blue-600"><a
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="2100">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-7.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="2300">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-8.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
                ...
                <div class="lessons-item group hover:-translate-y-2 duration-500" data-aos="fade-up" data-aos-delay="2600">
                    <div class="lessons-images relative overflow-hidden">
                        <a href="course.html"> <img class="rounded-t-md max-h-64 w-full object-cover"
                                                    src="{{asset('frontend/assets/images/webdesign-9.webp')}}" alt="images"></a>
                        <div class="  overlay-images rounded-t-xl   absolute top-0 w-full h-full bg-blue-5 left-0">
            ...
            <div class="popular-button mt-10 text-center">
                <a class="py-4 font-medium rounded transition duration-700 hover:bg-blue-800  hover:border-blue-600 hover:text-white px-8 border inline-block border-gray-300" href="course-catagory.html">View All </a>
            </div>
