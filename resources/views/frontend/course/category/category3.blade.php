            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-10">
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            ...
                            src="{{asset('frontend/assets/images/courses/courses-1.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Web Design</a> </h4>
                        <p class="md:text-lg  font-medium">60 Courses</p>
                    </div>
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-2.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">UI Design</a> </h4>
                        <p class="md:text-lg  font-medium">60 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-3.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">UX Design</a> </h4>
                        <p class="md:text-lg  font-medium">60 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                ...
                <div
                    ...
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Programming</a> </h4>
                        <p class="md:text-lg  font-medium">6 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                        <div class="flex-col">
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-5.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Art & Design</a> </h4>
                        <p class="md:text-lg  font-medium">16 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                        <div class="flex-col">
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-6.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Illustration</a> </h4>
                        <p class="md:text-lg  font-medium">18 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                        <div class="flex-col">
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-7.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Illustration</a> </h4>
                        <p class="md:text-lg  font-medium">10 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                        <div class="flex-col">
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-8.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Marketing</a> </h4>
                        <p class="md:text-lg  font-medium">5 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                        <div class="flex-col">
                ...
                <div
                    ...
                    <div class="popular-course-img overflow-hidden rounded-md">
                        <img
                            class=" w-[100%] max-h-52 rounded-md  object-cover transition duration-500 transform group-hover:scale-125"
                            src="{{asset('frontend/assets/images/courses/courses-9.webp')}}" alt="images">
                    </div>
                    <div class=" popular-text text-center my-6 ">
                        <h4><a class="md:text-2xl text-xl text-black-200 font-medium  transition duration-500 hover:text-blue-600"
                               href="course-catagory.html">Business promotions</a> </h4>
                        <p class="md:text-lg  font-medium">26 Courses</p>
                    </div>
                    <p class="text-sm text-black-200 mb-2">20+ Instrunctor</p>
                    <div class="poppular-course-footer flex justify-between items-center">
                        <div class="flex-col">
