            ...
            <div class="lg:grid lg:grid-cols-12 flex flex-col gap-12 lg:gap-0">
                <div class="col-span-8 lg:pr-20">
                    <div class="hero-content " data-animation="fadeInUp" data-delay="300">
                        <h1 class="font-serif !leading-tight text-4xl lg:text-6xl text-black-200 font-medium mb-6">
                            Figma UI UX Design Essentials Technique
                        </h1>
                        <div class="author flex items-center">
                            <img class="w-10 h-10 rounded-full object-fit" src="{{asset('frontend/assets/images/author/4.webp')}}" alt="author">
                            <div class="course-content ml-2">
                                ...
                                <p class="text-sm  font-normal opacity-60">California, USA</p>
                            </div>
                        </div>
                        <div class="author-rating pt-6 flex mb-6">
                           ...
                           <span class="courses-icon">
                              <svg width="29" height="16" viewBox="0 0 29 16" fill="none"
                                ...
                                <span class="courses-number  opacity-60 pl-1">10 Courses
                           </span>
                            </div>
                            ...
                            <div class="md:grid md:grid-cols-2 flex flex-col gap-6">
                                <div class="flex-col">
                                    <div class="instructor-profile shadow-3xl rounded bg-white p-5">
                                        <div class="profile-info flex gap-3 items-center mb-8">
                                            <div class="flex-col">
                                                <a href=""><img class="w-16 h-16 rounded-full" src="{{asset('frontend/assets/images/author/3.webp')}}"
                                                                alt="images"></a>
                                            </div>
                                            <div class="flex-col">
                                ...
                                <div class="flex-col">
                                    <div class="about-instructor">
                                        ...
                                        <p class="mb-3">Sharing is who I am, and teaching is where I am at my
                                            best, because
                                        ...
                                        <p>I've spent a long time watching others learn, and teach, to refine
                                            how I work with you to be efficient, useful and,
                                        </p>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="col-span-4">
                    <div class="courses-info-right p-6 shadow-4xl sticky top-32 transition duration-500">
                        ...
                        <h3 class="md:text-3xl text-2xl font-bold text-black-200 py-10">$ 39.00</h3>
                        <div class="courses-info">
                            ...
                            <div class="button-group flex gap-6 my-10 flex-wrap">
                                <a class="py-4 px-10 border-blue-50 border rounded inline-block text-black-200  hover:bg-blue-600 hover:border-blue-600 font-bold hover:text-white transition duration-500 "
                                   href="cart.html">Add to Cart</a>
                                <a class="py-4 px-10 hover:border-blue-50 border rounded inline-block hover:text-black-200  bg-blue-600 hover:bg-transparent  border-blue-600 font-bold text-white transition duration-500 "
