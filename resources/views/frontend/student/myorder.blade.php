        ...
        <div class="container">
            <div class="breadcrumb-titel md:w-7/12 m-auto text-center z-10 relative">
                <h2 class="xl:text-6xl lg:text-5xl md:text-4xl text-3xl text-black-200  font-medium" data-aos="fade-up"
                    data-aos-delay="100">My Order page</h2>
            </div>
                                             ...
                                             <path
                                                ...
                                                <div class="reviews-box border-t pt-7 mt-7 flex justify-between">
                                                    ...
                                                    @if($orderItem->order->payment_status == 'paid')
                                                        <h4 class="order-badge" style="background-color: #335CFF">Paid</h4>
                                                    @elseif($orderItem->order->payment_status == 'pending')
                                                        <h4 class="order-badge" style="background-color: #FF5733">Pending for Admin Approval</h4>
                                                    @elseif($orderItem->order->payment_status == 'due')
                                                        <h4 class="order-badge" style="background-color: red;">Due</h4>
                                                    @elseif($orderItem->order->payment_status == 'free')
                                                        <h4 class="order-badge" style="background-color: #335CFF;">Free</h4>
                                                    @endif
