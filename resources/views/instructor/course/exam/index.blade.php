        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Exam List</h2>
            ...
            <div class="content-header-right text-md-end col-md-3 col-12 d-md-block">
                <div class="mb-1 breadcrumb-right">
                    <a href="{{route('instructor.course.exam.create', [$course->uuid])}}">
                            ...
                            <table id="example"
                                ...
                                @foreach($exams as $exam)
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <a href="{{route('instructor.exam.question', [$exam->uuid])}}"
                                               class="btn btn-primary theme-btn theme-button1 default-hover-btn"
                                               style="width: 150px">Add Question</a>
                                        </td>

                                        <td style="display: flex; align-items: center; margin: 2px; gap: 4px; justify-content: center;">

                                            <a href="{{route('instructor.course.exam.edit', [$course->uuid, $exam->uuid])}}"
                                               title="Edit"
                                               class="btn-action">
                                                <button type="button"
                                                        class="btn  btn-info waves-effect waves-float waves-light">Edit
                                                </button>
                                            </a>

                                            <form id="form1" method="post" class="mb-0"
                                                  action="{{route('instructor.course.exam.delete', [$exam->uuid])}}">
                                                @csrf
