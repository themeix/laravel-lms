        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Edit Course Lesson</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit Course Lesson
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="needs-validation invoice-repeater"
                                  action="{{route('instructor.course.lesson.update',[$course->uuid, $course_lesson->uuid])}}" method="post"
                                    ...
                                    <div class="col-md-12 col-12">
                                        <div class="mb-1">
                                            ...
                                            <textarea
                                                ...
                                                rows="2"
                                                required
                                            >{{$course_lesson->short_description}}</textarea>
