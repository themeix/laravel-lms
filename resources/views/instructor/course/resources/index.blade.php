                                    ...
                                    <tr class="removable-item">
                                        ...
                                        <td>
                                            <div class="action__buttons">
                                                ...
                                                <form action="{{route('instructor.course.resource.delete', [$resource->uuid])}}" class="mb-0" method="post" class="d-inline">
                                                    @csrf

                                                    <a href="{{route('instructor.course.resource.delete', [$resource->uuid])}}"  class="btn-action confirm-delete"  title="Delete">
