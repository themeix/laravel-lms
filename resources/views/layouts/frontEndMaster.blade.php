                    ...
                    <div class="right-side-bar right-side-menu relative flex gap-4 flex-shrink-0">
                        <div class="author-profile">
                            ...
                            <div
                                ...
                                <div
                                    class="relative grid rounded-xl shadow grid-cols-1 gap-6 bg-white dark:bg-neutral-800 py-7 px-6">
                                    <div class="flex items-center space-x-3">
                                        ...
                                        <div class="flex-grow">
                                            <h4 class="font-semibold text-black-200">Eden Smith</h4>
                                            <p class="text-xs mt-0.5">Los Angeles, CA</p>
                                        </div>
                                    </div>
                                    <div class="w-full border-b border-neutral-200 dark:border-neutral-700"></div>
                                    <a class="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg  hover:bg-gray-200  dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                                       href="account.html">
                                        <div
                                        ...
                                        <div class="ml-4">
                                            <p class="text-sm font-medium text-black-200">My Account</p>
                                        </div>
                                    </a>
                                    <a class="flex items-center p-2 -m-3 transition duration-150 ease-in-out rounded-lg  hover:bg-gray-200  dark:hover:bg-neutral-700 focus:outline-none focus-visible:ring focus-visible:ring-orange-500 focus-visible:ring-opacity-50"
                                       href="cart.html">
        ...
        <div class="container">
            ...
            <div class="grid md:grid-cols-2 mt-16">
                ...
                <div class="flex-col md:text-right mt-6 md:mt-0" data-aos="fade-up" data-aos-delay="100">
                    <p class="">© 2022 All rights reserved by <a class="text-blue-600" href="#">themeix</a></p>
                </div>
            </div>
        </div>
    </footer>
