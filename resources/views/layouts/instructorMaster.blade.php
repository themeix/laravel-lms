    ...
    <div class="navbar-container d-flex content">
        ...
        <ul class="nav navbar-nav align-items-center ms-auto">
            ...
            <li class="nav-item dropdown dropdown-notification me-25"><a class="nav-link" href="javascript:void(0);"
                        ...
                        class="badge rounded-pill bg-danger badge-up">{{ sizeof($instructorNotifications) }}</span></a>
                <ul class="dropdown-menu dropdown-menu-media dropdown-menu-end">
                    <li class="dropdown-menu-header">
                        <div class="dropdown-header d-flex">
                            <h4 class="notification-title mb-0 me-auto">Notifications</h4>
                            <div class="badge rounded-pill badge-light-primary">{{ sizeof($instructorNotifications) }} New
                            </div>
                        </div>
                    </li>
                    <li class="scrollable-container media-list">
                        ...
                        @foreach($instructorNotifications as $instructorNotification)
                            <a class="d-flex" href="{{route('notification.url', [$instructorNotification->uuid])}}">
                                <div class="list-item d-flex align-items-start">
                                    <div class="me-1">

                                        @if($instructorNotification->sender->image != null)
                                            <div class="avatar"><img
                                                    src="{{ asset($instructorNotification->sender->image) }}"
                                    ...
                                    <div class="list-item-body flex-grow-1">
                                        <h6 class="color-heading font-14 text-capitalize">{{$instructorNotification->sender->name}}</h6>
                                        <p class="media-heading"><span
                                                class="fw-bolder">{{$instructorNotification->text}}</span>
                                        </p><small
                                            class="notification-text"> {{@$instructorNotification->created_at->diffForHumans()}}</small>
                                    </div>
                                </div>
                            </a>
                        @endforeach
            ...
            <li class="nav-item dropdown dropdown-user"><a class="nav-link dropdown-toggle dropdown-user-link"
                ...
                <div class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-user">
                    ...
                    <a class="dropdown-item" href="{{ route('instructor.changePassword') }}">
...
<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow" data-scroll-to-active="true">
    <div class="navbar-header">
        <ul class="nav navbar-nav flex-row">
            <li class="nav-item me-auto mb-5"><a class="navbar-brand" href="{{ route('instructor') }}"><span
                        class="brand-logo">
    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            <li class="nav-item {{ (request()->is('instructor/dashboard')) ? 'active' : '' }}"><a
                    class="d-flex align-items-center" href="{{ route('instructor') }} "><i data-feather="home"></i><span
            ...
            <li class=" nav-item  {{ (request()->is('instructor/course*')) ? 'active' : '' }}"><a
                    class="d-flex align-items-center" href="{{route('instructor.course.index')}}"><i
                        data-feather='log-in'></i><span class="menu-title text-truncate"
                                                        data-i18n="Invoice">My Courses</span></a>
            </li>

            <li class=" nav-item  {{ (request()->is('instructor/allEnrollStudent/index')) ? 'active' : '' }}"><a
                    class="d-flex align-items-center" href="{{route('instructor.allEnrollStudent.index')}}">
                    <i data-feather='users'></i><span class="menu-title text-truncate"
                                                      data-i18n="Invoice">All Students</span></a>
            </li>
            ...
            <li class=" nav-item  {{ (request()->is('instructor/discussion/index')) ? 'active' : '' }}"><a
                    ...
                    <i data-feather='message-square'></i><span class="menu-title text-truncate" data-i18n="Invoice">
                        Discussion</span></a>
            </li>

            <li class=" nav-item  {{ (request()->is('instructor/account/index')) ? 'active' : '' }}"><a
                    class="d-flex align-items-center" href="{{route('instructor.account.index')}}">
                    <i data-feather='dollar-sign'></i><span class="menu-title text-truncate" data-i18n="Invoice">
